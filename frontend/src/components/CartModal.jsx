...
function CartModal() {
    ...
    const escolherModoEntrega = (modo) => {
        setModoEntrega(modo)
        limparEntrega()
    }
    ...
    const calcularEntrega = async ({ lat = null, lng = null, origem = 'morada' } = {}) => {
        ...
        try {
            ...
            const payload = {
                morada: temCoordenadas
                    ? 'Ponto escolhido por GPS ou mapa'
                    : moradaCompleta,
                subtotal: totalPrice
            }
        ...
        navigator.geolocation.getCurrentPosition(
            async (position) => {
                ...
                try {
                    ...
                    console.log('Erro ao obter morada:', error)
                }
            ...
            () => {
                setErroEntrega(
                    'Não foi possível obter a localização. Confirma se deste permissão ao browser.'
                )
...
Preço: ${formatarEuros(item.preco)}€
Subtotal: ${formatarEuros(subtotal)}€`
        })
        .join('\n\n')
    ...
    const mensagem = `🥬 NOVA ENCOMENDA - A Menina da Horta
        ...
        📏 Distância:
        ${entregaInfo?.distance_km || '--'} km

        ⏱️ Tempo estimado:
        ${entregaInfo?.duration_min || '--'} min
        ...
        Subtotal: ${formatarEuros(totalPrice)}€
        Entrega: ${getEntregaTexto()}
        Total Final: ${getTotalTexto()}

        ━━━━━━━━━━━━━━━

        Obrigado 🌱`

            return `https://api.whatsapp.com/send?phone=${numeroWhatsApp}&text=${encodeURIComponent(mensagem)}`
        }
            ...
            <div className="cart-modal">
                ...
                <div className="cart-header">
                    ...
                    <div>
                        ...
                        <p>
                            Escolhe a forma de entrega, calcula o valor e confirma pelo WhatsApp.
                        </p>
                    </div>
                    ...
                    <>
                        ...
                        <div className="cart-form-grid">
                            ...
                            <div className="cart-field cart-field-full">
                                <label>Como queres indicar a entrega?</label>

                                <div className="delivery-choice-grid">
                                    <button
                                        type="button"
                                        className={modoEntrega === 'gps' ? 'delivery-choice active' : 'delivery-choice'}
                                        onClick={() => escolherModoEntrega('gps')}
                                    >
                                        📍 Usar GPS
                                        <span>Mais rápido no telemóvel</span>
                                    </button>

                                    <button
                                        type="button"
                                        className={modoEntrega === 'manual' ? 'delivery-choice active' : 'delivery-choice'}
                                        onClick={() => escolherModoEntrega('manual')}
                                    >
                                        ✍️ Inserir morada
                                        <span>Rua, número e código postal</span>
                                    </button>
                                </div>
                            </div>
                                ...
                                <>
                                    <div className="cart-field cart-field-full">
                                        ...
                                        >
                                            {aCalcularEntrega
                                                ? 'A obter localização...'
                                                : '📍 Usar localização GPS do telemóvel'}
                                        </button>

                                        {(rua || localidade) && (
                                            <div className="gps-address-preview">

                                                <strong>📍 Morada detectada</strong>
                                        ...
                                        <small className="delivery-helper">
                                            O browser vai pedir permissão. Depois podes ajustar o ponto no mapa.
                                        </small>
                                    </div>
                                    ...
                                    <div className="cart-field cart-field-full">
                                        ...
                                        <textarea
                                            ...
                                            placeholder="Ex: Portão verde, tocar no 2º esquerdo..."
                                        />
                                    </div>
                                </>
                            )}
                ...
                {confirmacaoAberta && (
                    <div className="confirm-backdrop">
                        <div className="confirm-modal">
                            ...
                            <p>
                                Confirma se os produtos, a entrega, o ponto no mapa e o valor estão corretos.
                            </p>
                            ...
                            <div className="confirm-address">
                                ...
                                <span>
                                    {entregaInfo?.destination_label || moradaCompleta}
                                </span>
                            </div>
